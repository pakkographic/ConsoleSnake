...
function mergeDefault(base, overwrites) {
  ...
  for (const [baseKey, baseValue] of Object.entries(base)) {
    ...
    if (typeof overwritesValueAtBaseKey === "undefined") {
      Reflect.set(overwrites, baseKey, deepClone_cjs.deepClone(baseValue));
    } else if (isObject_cjs.isObject(overwritesValueAtBaseKey)) {
...
//# sourceMappingURL=mergeDefault.cjs.map
//# sourceMappingURL=mergeDefault.cjs.map